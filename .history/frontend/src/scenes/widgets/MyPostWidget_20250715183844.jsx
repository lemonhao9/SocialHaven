        ...
        <WidgetWrapper>
            ...
            {isNonMobileScreens ? (
                ...
                <FlexBetween gap="0.25rem">
                    ...
                    <Typography color={mediumMain}>Joindre gif</Typography>
                </FlexBetween>

                <FlexBetween gap="0.25rem">
                    <AttachFileOutlined sx={{color:mediumMain}}/>
                    <Typography color={mediumMain}>Joindre fichier</Typography>
                </FlexBetween>
            ...
            <Button disabled={!post} onClick={handlePost} sx={{color:palette.background.alt, backgroundColor: palette.primary.main, borderRadius: "3rem"}}>Poster</Button>
            </FlexBetween>
        </WidgetWrapper>
    )
};
