...
const Form = () => {
    ...
    const register = async (values, onSubmitProps) => {
        const formData = new FormData(); //permet d'envoyer des img avec le formulaire
        ...
        {({
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Box>
                    ...
                    >
                        {isLogin ? "Pas encore de compte ? Inscris-toi ici !" : "Vous avez déjà un compte ? connectez-vous ici !"}
                    </Typography>
                </Box>
            </form>
        )}
